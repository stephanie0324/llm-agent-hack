...
<h1 align="center"> Travel Buddy </h1>
...
<div align="center">
    <p>
    This is a Travel Planning Agent implemented through Streamlit and Langchain, using the LLM Agent Framework. 
    <br>
    A website to discover, plan, book and play, just with one click.
    <br>
    <h4 align="center">
    <p>
...
This is a implementation of LLM agent by [Langchain](https://www.langchain.com/), and a chatbot interface built with [Streamlit](https://streamlit.io/) 

<div align="center">
<p class="image-cropper">
    <img  src = "" />
</p> Travel Buddy Interface 
</div>
<br>
